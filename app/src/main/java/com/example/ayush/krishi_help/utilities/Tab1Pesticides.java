...
public class Tab1Pesticides extends Fragment {
//    ProgressDialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.prices_tab1_pesticides, container, false);
...
//        dialog.setMessage(getString(R.string.pricePesticide));
//        dialog.show();
