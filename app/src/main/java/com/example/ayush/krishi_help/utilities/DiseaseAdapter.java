 ...
 */
public class DiseaseAdapter extends ArrayAdapter<JSONObject> {
    ArrayList<JSONObject> list;
    Context context;


    public DiseaseAdapter(Context c, ArrayList<JSONObject> list)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            convertView = vi.inflate(R.layout.listitem_disease, null);
        }
